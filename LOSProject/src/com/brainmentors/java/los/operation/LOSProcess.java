...
import com.brainmentors.java.los.utils.CommonConstants;
import com.brainmentors.java.los.utils.LoanConstants;
...
public class LOSProcess implements StageConstants, CommonConstants {
	...
	public void checkStage(int applicationNumber)
	{
		...
		if(!isStageFound)
		{
			System.out.println("Invalid Aplication Number");
		}
	}
}
